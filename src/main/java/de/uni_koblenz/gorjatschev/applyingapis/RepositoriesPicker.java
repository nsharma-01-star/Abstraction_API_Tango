...
public class RepositoriesPicker {
    ...
    private static final String USERNAME_AND_TOKEN = "Pavithree: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";
    ...
    private static List<String> filterRepositories(int starsLimit, int contributorsLimit, int commitsLimit)
        ...
        for (int page = 1; page <= 10; page++) {
            ...
            for (JsonElement e : items) {
                ...
                if ((pomFiles.get("total_count").getAsInt() == 0) || (pomFiles.get("total_count").getAsInt() >= 2)) {
                    continue;
                }
